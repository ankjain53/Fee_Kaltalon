...
WebUI.setText(findTestObject('TC_24_36 AM/Input_MerId'), findTestData('Feedzai_Automation_TestData').getValue(5, 8))
...
WebUI.verifyElementText(findTestObject('TC_24_36 AM/Mer_id_Valid'), '100001000022526')

WebUI.comment('Merchant  Details Displayed through phone number')

Merchant_Details_phoneNo = WebUI.takeScreenshot()
